...
public class MergingTables {
    ...
    void merge(int desIndex, int srcIndex, Table[] tables) {
        ...
        if (realDestination.rank > realSource.rank) {
            ...
            realSource.parent = realDestination.getParent();    // noi source vao des
            ...
            realDestination.parent = realSource.getParent();    // noi parent vao source
            if (realDestination.rank == realSource.rank)
                realSource.rank += 1;
    ...
    public void run() {
        ...
        for (int i = 0; i < m; i++) {
            ...
            merge(destination, source, tables);
            writer.printf("%d\n", maximumNumberOfRows);
        }
    }
